    ...
    <div>
        ...
        <div class="table-body">
            ...
            <div class="table-left-top">
                <el-button v-auth="'add'" type="primary" icon="el-icon-plus" @click="onAdd">{{ $i18n.t('ADD') }}</el-button>
...
<!--                <el-table-column align="center" sortable prop="id" label="ID" :width="100" fixed="left"></el-table-column>-->
                <el-table-column align="center" prop="country_id" :label="$i18n.t('COUNTRY')" :min-width="150">
                    <template slot-scope="scope">
                        <span v-if="scope.row.country !== null">{{ scope.row.country.name_text }}</span>
                        <span v-else>-</span>
                    </template>
                </el-table-column>
                <el-table-column align="center" prop="name" :label="$i18n.t('BANK_NAME')" :min-width="150"></el-table-column>
                <el-table-column align="center" prop="code" :label="$i18n.t('BANK_CODE')" :min-width="150"></el-table-column>
...
<script>
    ...
    import FormModal from '@/components/countryBankCode/FormModal'
    import { PAGES_SIZE } from '@/config/constants'
    import { getBankCodeList, deleteBankCode } from '@/api/countryBankCode'
    ...
    export default {
        ...
        computed: {
            formItems () {
                ...
                return [
                    ...
                    { title: this.$i18n.t('BANK_CODE'), type: 'input', key: 'code' }
                ]
            },
            isShowDivider () {
        ...
        methods: {
            ...
            fetch () {
                ...
                getBankCodeList({ ...this.params, page: this.page.currentPage, perPage: this.page.perPage }).then((res) => {
