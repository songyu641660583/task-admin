    ...
    <div>
        ...
        <div class="table-body">
            ...
            <div class="table-left-top">
                <el-button v-auth="'add'" type="primary" icon="el-icon-plus" @click="onAdd">{{ $i18n.t('CREATE_BANNER') }}</el-button>
            ...
            <el-table border style="width: 100%;" stripe :data="data" v-loading="loading" row-key="id" @selection-change="handleSelectionChange">
                ...
                <el-table-column align="center" prop="image" :label="$i18n.t('BANNER_IMAGE')" :min-width="150">
                ...
                <el-table-column align="center" prop="url" :label="$i18n.t('URL')" :min-width="150"></el-table-column>
...
<script>
    ...
    import FormModal from '@/components/banner/FormModal'
    ...
    export default {
        ...
        methods: {
            ...
            fetch () {
                this.loading = true
                getBannerList({ ...this.params, page: this.page.currentPage, perPage: this.page.perPage }).then((res) => {
