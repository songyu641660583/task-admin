    ...
    <div>
        ...
        <div class="table-body">
            ...
            <div class="table-left-top">
                <el-button v-auth="'add'" type="primary" icon="el-icon-plus" @click="onAdd">{{ $i18n.t('CREATE_QR_CODE') }}</el-button>
                ...
                <el-button v-auth="'delete'" type="danger" icon="el-icon-custom-delete" :disable="checkedIds.length === 0" @click="onDelete(checkedIds)">{{ $i18n.t('DELETE') }}</el-button>
            </div>
            <!-- 表格 -->
            <el-table border style="width: 100%;" stripe :data="data" v-loading="loading" row-key="id" @selection-change="handleSelectionChange">
                ...
                <el-table-column align="center" prop="image" :label="$i18n.t('RECHARGE_QR_CODE')" :min-width="150">
                    <template slot-scope="scope">
                        <el-image  :preview-src-list="[config.staticUrl + scope.row.image]" :src="config.staticUrl + scope.row.image" style="width: 50%;height: 50%" fit="scale-down"></el-image>
                    </template>
                </el-table-column>
...
<script>
    ...
    import { getQrCodeList, enableQrCodes, disableQrCodes, deleteQrCodes } from '@/api/RechargeQrCode'
    import configs from '@/config'
    import ElImageViewer from 'element-ui/packages/image/src/image-viewer'
    import FormModal from '@/components/rechargeQrCode/FormModal'
    ...
    export default {
        ...
        methods: {
            ...
            fetch () {
                this.loading = true
                getQrCodeList({ ...this.params, page: this.page.currentPage, perPage: this.page.perPage }).then((res) => {
            ...
            // 启用选中
            onEnable () {
                enableQrCodes(this.checkedIds.join(',')).then(() => {
            ...
            // 禁用选中
            onDisable () {
                disableQrCodes(this.checkedIds.join(',')).then(() => {
                    this.$Message.success(this.$i18n.t('HANDLE_SUCCESS'))
                    setTimeout(() => {
                        this.fetch()
                    }, 500)
