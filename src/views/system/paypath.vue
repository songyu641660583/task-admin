...
<script>
    import { getPayField, delPayField } from '@/api/default/paypath'
    ...
    export default {
        ...
        methods: {
            ...
            fetch () {
                this.loading = true
                getPayField({ ...this.params, page: this.page.currentPage, perPage: this.page.perPage }).then((res) => {
