...
<!--                                </el-select>-->
                                <Input prefix="ios-person-outline" type="text" v-model="loginJson.username" autofocus clearable placeholder="请输入账号" />
                            </FormItem>
                            <FormItem prop="passWord">
                                <Input prefix="ios-lock-outline" type="password" v-model="loginJson.password" clearable placeholder="请输入密码" />
                            </FormItem>
                            <FormItem prop="code">
                                <Input prefix="logo-google" type="text" v-model="loginJson.googleCode" clearable placeholder="请输入谷歌验证码" />
                            </FormItem>
                            <!--<FormItem>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            sendMsg () {
                getCode({ add_num: this.loginJson.add_num, phone: this.loginJson.username }).then(() => {
