<template>
    <div class="body">
        <el-form :model="mdl" ref="ruleForm" label-width="130px">
            ...
            <el-form-item :label="$i18n.t('COUNTRY_PHONE_CODE')" required :error="errors.country_code">
<!--                <el-input v-model="mdl.country_code" :placeholder="$i18n.t('PLEASE_INPUT', { value: $i18n.t('COUNTRY_PHONE_CODE') })"></el-input>-->
                <el-select v-model="mdl.country_code" :value="mdl.country_code">
