<template>
    <div class="body">
        <el-form :model="mdl" ref="ruleForm" label-width="130px">
            ...
            <el-form-item :label="$i18n.t('TASK_CATEGORY')">
                <span v-if="mdl.category !== null">{{ mdl.category.name_text }}</span>
                <span v-else>-</span>
            </el-form-item>
            <el-form-item :label="$i18n.t('MEMBER_LEVEL')">
            ...
            <el-form-item :label="$i18n.t('TASK_URL')">
                <el-link :href="mdl.url" target="_blank" type="primary" icon="el-icon-link">
                    {{ $i18n.t('TASK_URL') }}
                </el-link>
            </el-form-item>
            <el-form-item :label="$i18n.t('TASK_DESCRIPTION')">
                <span>{{ mdl.description }}</span>
            </el-form-item>
            <el-form-item :label="$i18n.t('TASK_AMOUNT')">
...
<script>
    import { auditTaskAudit } from '@/api/taskAduit'
