<template>
    <div class="body">
        <el-form :model="mdl" ref="ruleForm" label-width="130px">
            ...
            <el-form-item :label="$i18n.t('COUNTRY_PHONE_CODE')" required :error="errors.phone_code">
                <el-input v-model="mdl.phone_code" :placeholder="$i18n.t('PLEASE_INPUT', { value: $i18n.t('COUNTRY_PHONE_CODE') })"></el-input>
            </el-form-item>
            ...
            <el-form-item :label="$i18n.t('EXCHANGE_RATE')" required :error="errors.exchange_rate">
                <el-input-number v-model="mdl.exchange_rate" style="width: 200px" :precision="3" :placeholder="$i18n.t('PLEASE_INPUT', { value: $i18n.t('EXCHANGE_RATE') })"></el-input-number>
            </el-form-item>
            <el-form-item>
                <Alert show-icon style="font-size: 12px">{{ $i18n.t('EXCHANGE_RATE_TIP') }}</Alert>
            </el-form-item>
            <!-- 默认添加广告 注释隐藏添加轮播 -->
