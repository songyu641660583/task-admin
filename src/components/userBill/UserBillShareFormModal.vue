<template>
    <div class="body">
        <el-form :model="mdl" ref="ruleForm" label-width="130px">
            ...
            <el-form-item :label="$i18n.t('PARENT_ID')" >
                <span >{{ mdl.parent_id }}</span>
            </el-form-item>
            <el-form-item :label="$i18n.t('NEW_PARENT_ID')">
                <el-input-number v-model="parent_id" :placeholder="$i18n.t('NEW_PARENT_ID')" style="width: 200px;"></el-input-number>
            </el-form-item>
...
<script>
    import { changeParentId } from '@/api/member'
    ...
    export default {
        ...
        methods: {
            submitForm () {
                ...
                this.errorMessage = ''
                changeParentId({ id: this.mdl.id, parent_id: this.parent_id }).then(() => {
                    // 关闭抽屉
                    this.handleCloseDialog()
